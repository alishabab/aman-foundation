    ...
    <div className="py-8 px-2">
      <div className="mb-8">
        ...
        <p className="mt-2">
          ...
          vel ipsam ducimus aliquam et veniam neque inventore ad quisquam. Odio,
          excepturi quia? Et vero, ullam fuga tempora ea nemo aut accusamus
          quibusdam praesentium repellat dolor dicta ut. Esse, officiis cum!
        </p>
      </div>
      <div className="mb-8">
